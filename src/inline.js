...
const inject = `
  var extension = unescape('${escape(fs.readFileSync(path.join(__dirname, '../dist/extension.js')).toString())}')
  try {
...
copy(['./manifest.json', './pop.html', './settings.html', './settings.js', './icon.png', './icon.png'])
